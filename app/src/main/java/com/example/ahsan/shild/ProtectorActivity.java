...
public class ProtectorActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        if (getApplicationContext()!=null){
            ...
            Toast.makeText(ProtectorActivity.this,"Not found",Toast.LENGTH_LONG).show();
        }
